	...
	<div class="contain">
		<div class="content">
			...
			<div class="content-right">
				<nav class="tab_nav">		
					<ul id="tabs">
						<li onclick="goPage1(1,3)"><a class="current" href="#">正在预约</a></li>
						<li onclick="goPage2(1,3)"><a href="#">完成订单</a></li>
					</ul>
				...
				<div id="content">	
					<section>				
							<div id="order_info1">
							<c:forEach items="${bookMessages}" var="list">
							<div class="info">
					...
					<section>		
							<div id="order_info2">
							<c:forEach items="${successOrders}" var="list">
							<div class="info">
								<div class="custom-table">
									<table>
										<tr>
